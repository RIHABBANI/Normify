...
export const RaksTable = () => {
    ...
    const [selectedRak, setSelectedRak] = useState(null);    const [formData, setFormData] = useState({
        NOM_RAK: '',
        ID_RAME: '',
        MOTRICE: 'M'
    });
    ...
    const openEditModal = (rak, e) => {
        ...
        setSelectedRak(rak);        setFormData({
            NOM_RAK: rak.NOM_RAK || '',
            ID_RAME: rak.ID_RAME || '',
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
            ...
            {!raks.length ? (
                <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-200">
                    ...
                    <p className="text-yellow-600">Il n'y a pas encore de raks dans le système.</p>
                    <button
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg p-6 w-full max-w-md shadow-xl">
                        ...
                        <form onSubmit={handleAddRak} className="space-y-4">
                            ...
                            <div>
                                <label className="block text-gray-700 text-sm font-bold mb-2">Rame</label>
                                <select
                                    name="ID_RAME"
